...
// "server-only" sorgt für einen Build-Fehler, falls diese Datei
// versehentlich (direkt oder transitiv) von einer Client Component
// importiert wird - siehe den ausführlichen Kommentar in lib/ideas.ts für
// den konkreten Vorfall, den das verhindern soll (Anthropic-Client landete
// im Browser-Bundle und crashte dort beim Laden).
...
export async function addIdea(
  ...
  const next: Idea = {
    ...
    text: trimmed,
    category: isValidIdeaCategory(category) ? category : "sonstiges",
